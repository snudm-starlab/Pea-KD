...
from utils.data_processing import init_model, get_task_dataloader, init_model_ER
...
from utils.utils import load_model, count_parameters, eval_model_dataloader_nli, eval_model_dataloader, compute_metrics, load_model_finetune, eval_model_dataloader_nli_finetune
...
if args.kd_model.lower() in ['kd', 'kd.cls', 'kd.u', 'kd.i']:
    ...
    student_encoder, student_classifier = init_model_ER(task_name, output_all_layers, args.student_hidden_layers, student_config)
...
if args.do_train:
    ...
    for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
        ...
        for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
            ...
            full_output, pooled_output = student_encoder(input_ids, segment_ids, input_mask, rand_shuffle = shuf)    
        ...
        #Save a trained model and the associated configuration
            if (global_step % 2 == 1) & (epoch > -1): 
                if 'race' in task_name:
                    ...
                    test_res = eval_model_dataloader_nli_finetune(args.task_name.lower(), eval_label_ids, student_encoder, student_classifier, eval_dataloader, args.kd_model, num_labels, device, args.weights, args.fc_layer_idx, output_mode, rand_shuffle = [False, False, False, False, False, False])                
